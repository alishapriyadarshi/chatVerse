...
export const DUMMY_USERS: User[] = [
  ...
  { id: 'user-guest', name: 'Guest', avatarUrl: 'https://placehold.co/100x100', isGuest: true },
];
...
export const DUMMY_MESSAGES: { [conversationId: string]: Message[] } = {
  'conv-1': [
    ...
    { id: 'msg-1-2', sender: CURRENT_USER, text: 'Hi Bob! How are you?', timestamp: tenMinutesAgo },
  ...
  'conv-2': [
    ...
    { id: 'msg-2-3', sender: CURRENT_USER, text: 'Awesome, I\'ll review them now.', timestamp: fiveMinutesAgo },
  ],
  'conv-3': [
...
export const DUMMY_CONVERSATIONS: Conversation[] = [
  ...
  },
  {
    ...
    type: 'group',
    name: 'Project Team',
    participants: [CURRENT_USER, DUMMY_USERS[2], DUMMY_USERS[3]],
    avatarUrl: 'https://placehold.co/100x100',
